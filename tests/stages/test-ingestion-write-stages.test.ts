...
import MetadataWriterStage = require('../../src/stages/ingestion/metadata-writer');
import VectorIndexerStage = require('../../src/stages/ingestion/vector-indexer');
import CooccurrenceBuilderStage = require('../../src/stages/ingestion/co-occurrence-builder');
import FileDeleterStage = require('../../src/stages/ingestion/file-deleter');
import { decodeVectorBlob } from '../../src/utils/vector-codec';
import type {
...
function chunkEntry(index: number, vector?: VectorLike, content?: string) {
  return {
    chunkIndex: index,
...
function tagEntry(name: string, vector?: VectorLike) {
