 ...
 */
function computeRiverObservability(
  riverGraph: RiverGraph | null | undefined,
  options: ObservabilityOptions = {},
): Readonly<RiverObservabilityResult> {
