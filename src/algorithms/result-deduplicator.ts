...
import type { SearchResult, SourcePriority, UnknownRecord, Vector } from '../types';
...
class ResultDeduplicator {
    ...
    _compareCandidates(a: RankedCandidate, b: RankedCandidate, queryVector: Vector | null): number {
    ...
    _toValidVector(value: unknown): Vector | null {
        if (!value || typeof value !== 'object' || !('length' in value)
            || typeof value.length !== 'number') return null;
