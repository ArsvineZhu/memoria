...
- Every runnable tutorial must use only the package root or the supported public subpaths: `memoria`, `memoria/adapters/filesystem`, `memoria/errors`, and `memoria/providers/openai-compatible`.
