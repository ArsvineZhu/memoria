import type { PipelineContextLike, PipelineData, Stage as StageContract } from '../types';
 ...
 */
class Stage<Input = PipelineData, Output = PipelineData>
  implements StageContract<Input, Output> {
  name?: string;
  /**
