...
module.exports = {
  ...
  normalizeRetrievalPlan: esmApi.normalizeRetrievalPlan,
  applyRetrievalPlan: esmApi.applyRetrievalPlan,
  mergeRetrievalPlan: esmApi.mergeRetrievalPlan,
  planRetrieval: esmApi.planRetrieval,
  planRetrievalAsync: esmApi.planRetrievalAsync,
  chooseStrategy: esmApi.chooseStrategy,
  readGraphReadiness: esmApi.readGraphReadiness,
  profileNaturalLanguageQuery: esmApi.profileNaturalLanguageQuery,
  extractMdxRelations: esmApi.extractMdxRelations,
  relationDocumentKey: esmApi.relationDocumentKey,
  RelationGraphStore: esmApi.RelationGraphStore,
  ...
  parseMdxDocument: esmApi.parseMdxDocument,
};
